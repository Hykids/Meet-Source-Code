        ...
        <div class="registerBox">
          ...
          >
            ...
            <el-form-item prop="email">
              <el-input v-model="ruleForm.email" placeholder="输入邮箱注册">
                clearable ></el-input
              >
            </el-form-item>
            ...
            <el-form-item>
              <el-button id="register" type="primary" @click="register()"
                >注册</el-button
              >
            </el-form-item>
          </el-form>
...
<script>
// import {} from "../canvas/background.js";
...
export default {
  ...
  mounted() {
    ...
    script.src = require("../canvas/background.js");
  ...
  methods: {
    ...
    sendCode() {
      ...
      let data = qs.stringify({ email: this.ruleForm.email });
      request
        .post("/living/user/sendEmailCode", data, {
          headers: {
    ...
    register() {
      ...
      request
        .post("/living/user/registByEmail", data, {
          headers: { "content-type": "application/x-www-form-urlencoded" },
          token:
            "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6MSwiZXhwIjoxNjUwOTYzMDMwfQ.Fu5WFT0lTVljTaIq7w9PeZOq7bbFJjCbXDbrbTlngSE",
        })
        .then((res) => {
          //请求成功后执行函数
          if (res.code == "00000") {
...
.el-button {
  margin-left: 12px;
  background-image: linear-gradient(to right, #dcb3d3 0%, #9face6 100%);
}
