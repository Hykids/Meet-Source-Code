      ...
      <div class="content">
        ...
        <div class="loginBox">
          <el-form
            ...
            label-width="120px"
          >
            <el-form-item style="height: 35px; margin-left: 85px"
              ><p>Login</p>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    Login() {
      ...
      request
        .post("/living/user/login/byEmail", data, {
        ...
        .then((res) => {
          ...
          if (res.code == "00000") {
            ...
            store.commit("setId", res.data.userInfo.id);
            store.commit("setAvatar", res.data.userInfo.avatar);
            store.commit("setUsername", res.data.userInfo.username);
            store.commit("loginSex", res.data.userInfo.sex);
            useWebSocket();
